...
namespace FlowplaneExtensions.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult FlowDetail(string fpxtpms)
        {
            ...
            if (pms.extensionCode.Equals(new Extensions.Facebook.Identity().Code, StringComparison.CurrentCultureIgnoreCase))
                return RedirectToAction("FlowDetail", "Facebook", new { fpxtpms = fpxtpms });
